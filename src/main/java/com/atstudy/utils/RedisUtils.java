...
@Component                      //托管给spring框架，由上下文来进行实例化
public final class RedisUtils {//帮助类工具类，更方便的操作redis的对象
    //让java代码去操作（增加更新set/查询get/当key不存在时设置命令setnx）redis的对象，和redis-cli的命令保持一致————————收益：使用方便+增加代码可读性

    @Resource
    private RedisTemplate<String, Object> redisTemplate;

    /**
     * 指定缓存失效时间,,,,设置生命周期：expire key seconds
     *
     * @param key  键
     * @param time 时间(秒)
     * @return
